...
func TestInsertLog(t *testing.T) {
	if err := InsertLog("S59ABC-NOV2020.edi", log.TypeEdiFile); err != nil {
	...
	if err := InsertLog("S59ABC-MAR2021.edi", log.TypeEdiFile); err != nil {
		fmt.Println(err.Error())
	}
	...
	if err := InsertLog("vhf.txt", log.TypeN1mmCallHistory); err != nil {
		fmt.Println(err.Error())
	}
	...
	if err := InsertLog("S59ABC-VHF-SEP2019.txt", log.TypeEdiFile); err == nil {
	...
	if err := InsertLog("S59ABC-VHF-SEP2019.txt", log.TypeN1mmGenericFile); err != nil {
		t.Error(err.Error())
	}
